...
#tx_rend_painel <- read_dta("data/tx_rend_painel_2.dta")
...
resultados_t_df_aprov_ai <- read.csv2("data/teste_t_aprov_ai.csv")

resultados_t_df_reprov_ai <- read.csv2("data/teste_t_reprov_ai.csv")

resultados_t_df_aband_ai <- read.csv2("data/teste_t_aband_ai.csv")

resultados_t_df_aprov_af <- read.csv2("data/teste_t_aprov_af.csv")

resultados_t_df_reprov_af <- read.csv2("data/teste_t_reprov_af.csv")

resultados_t_df_aband_af <- read.csv2("data/teste_t_aband_af.csv")

resultados_t_df_aprov_em <- read.csv2("data/teste_t_aprov_em.csv")

resultados_t_df_reprov_em <- read.csv2("data/teste_t_reprov_em.csv")

resultados_t_df_aband_em <- read.csv2("data/teste_t_aband_em.csv")

#### mapa por etapa - regioes ####

# Ler o arquivo shapefile com os limites geográficos dos municípios
limites_regioes <- readOGR("data/malha_territorial_brasil/BR_UF_2022/BR_UF_2022.shx")
...
ggsave("results/figures/mapaA1_aprov_ai_regiao.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA1_reprov_ai_regiao.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA1_aband_ai_regiao.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA1_aprov_af_regiao.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA1_reprov_af_regiao.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA1_aband_af_regiao.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA1_aprov_em_regiao.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA1_reprov_em_regiao.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA1_aband_em_regiao.png", width = 4, height = 3, dpi = 300)


#### teste t das tx de rendimento por estado para cada etapa de ensino ####

resultados_t_df_aprov_ai <- read.csv2("data/teste_t_aprov_ai_estado.csv")

resultados_t_df_reprov_ai <- read.csv2("data/teste_t_reprov_ai_estado.csv")

resultados_t_df_aband_ai <- read.csv2("data/teste_t_aband_ai_estado.csv")

resultados_t_df_aprov_af <- read.csv2("data/teste_t_aprov_af_estado.csv")

resultados_t_df_reprov_af <- read.csv2("data/teste_t_reprov_af_estado.csv")

resultados_t_df_aband_af <- read.csv2("data/teste_t_aband_af_estado.csv")

resultados_t_df_aprov_em <- read.csv2("data/teste_t_aprov_em_estado.csv")

resultados_t_df_reprov_em <- read.csv2("data/teste_t_reprov_em_estado.csv")

resultados_t_df_aband_em <- read.csv2("data/teste_t_aband_em_estado.csv")

#### mapa por etapa - estados ####

# Ler o arquivo shapefile com os limites geográficos dos municípios
limites_estados <- readOGR("data/malha_territorial_brasil/BR_UF_2022/BR_UF_2022.shp")
# Converter o objeto Spatial para sf
...
#salvar resultados em mapas test-t por regiao
ggsave("results/figures/mapaA2_aprov_ai_estado.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA2_reprov_ai_estado.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA2_aband_ai_estado.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA2_aprov_af_estado.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA2_reprov_af_estado.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA2_aband_af_estado.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA2_aprov_em_estado.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA2_reprov_em_estado.png", width = 4, height = 3, dpi = 300)
ggsave("results/figures/mapaA2_aband_em_estado.png", width = 4, height = 3, dpi = 300)
